...
Laboratory for Analysis and Architecture of Systems (LAAS-CNRS), one of the largest research labs of the French state research organisation, CNRS. LAAS is located in Toulouse, France.
...
.. container:: expert
   ...
   * :math:`μ` is the dynamic viscosity of the fluid (Pa·s or N·s/m<sup>2</sup> or kg/(m·s))
   * :math:`ν` is the kinematic viscosity of the fluid (m<sup>2</sup>/s).
