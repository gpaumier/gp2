...
-  La `nouvelle version du codec Theora <https://diff.wikimedia.org/2009/09/theora-1-1-released/>`__ (1.1) a été publiée.
-  La Wikimedia Foundation va `sponsoriser le travail de Siebrand Mazeland <https://diff.wikimedia.org/2009/10/supporting-translatewiki-net/>`__ un jour par semaine afin de soutenir la plate-forme de traduction `translatewiki.net <http://translatewiki.net>`__.
-  Un wiki de test a été mis en place pour `tester la configuration de FlaggedRevisions <https://diff.wikimedia.org/2009/09/flaggedrevs-test-wiki-awaits-you/>`__ qui sera appliquée à Wikipedia en anglais.
-  Un autre wiki de test a aussi été installé pour `tester LiquidThreads <https://diff.wikimedia.org/2009/10/mediawikis-new-discussion-system-in-testing-on-wikimedia-labs/>`__, le nouveau système de discussion de MediaWiki.
