...
.. highlights::
   ...
   In this essay, I imagine scenarios about the world in 2030 and :doc:`Wikimedia's <wikimedia>` place in it. The actual future is likely to be a combination of (favorable and unfavorable) elements from all these scenarios.

(Additional context is available at the end.)
...
made into cards for activity :doc:`Advancement <advancement>`
