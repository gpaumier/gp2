...
require.register("foundation-sites/js/foundation.core.js", function(exports, require, module) {
  require = __makeRelativeRequire(require, {"transform":[["babelify",{"presets":["@babel/preset-env"]}]]}, "foundation-sites");
  (function() {
    "use strict";
...
require.register("foundation-sites/js/foundation.core.plugin.js", function(exports, require, module) {
  require = __makeRelativeRequire(require, {"transform":[["babelify",{"presets":["@babel/preset-env"]}]]}, "foundation-sites");
  (function() {
    'use strict';
...
require.register("foundation-sites/js/foundation.core.utils.js", function(exports, require, module) {
  require = __makeRelativeRequire(require, {"transform":[["babelify",{"presets":["@babel/preset-env"]}]]}, "foundation-sites");
  (function() {
    "use strict";
...
var _foundationUtil3 = require("./foundation.util.touch");
...
var Dropdown = /*#__PURE__*/function (_Positionable) {
  ...
  _createClass(Dropdown, [{
    ...
    value: function _destroy() {
      ...
      (0, _jquery["default"])(document.body).off('click.zf.dropdown tap.zf.dropdown');
    }
  }]);
  ...
  _createClass(DropdownMenu, [{
    ...
    value: function _events() {
      ...
      this.$menuItems.on('keydown.zf.dropdownMenu', function (e) {
        var $element = (0, _jquery["default"])(e.target).parentsUntil('ul', '[role="none"]'),
    ...
    value: function _addBodyHandler() {
      ...
      $body.on('click.zf.dropdownMenu tap.zf.dropdownMenu', function (e) {
        var isItself = !!(0, _jquery["default"])(e.target).closest(_this2.$element).length;
        if (isItself) return;
...
Triggers.Listeners.Basic = {
  ...
  closeableListener: function closeableListener(e) {
    var animation = (0, _jquery["default"])(this).data('closable'); // Only close the first closable element. See https://git.io/zf-7833
