...
BLOG_DESCRIPTION = {"en": "defying the Second Law of Thermodynamics since 1982", "fr": "défiant la deuxième loi de la thermodynamique depuis 1982"}  # (translatable)
...
PAGES = (
    ...
    ("src/projects/*.rst", "projects", "story.tmpl"),
)
